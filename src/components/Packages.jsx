    ...
    <div className="w-full p-8">
      ...
      <div className="md:flex gap-4">
          ...
          <div className="flex justify-between">
            ...
            <div>
              <button
                ...
                className="bg-[#6AD2FF] text-white md:p-3 p-2 rounded-xl font-semibold"
              >
                Create Package
              </button>
            </div>
              ...
              >
                <div onClick={() => handlePackageClick(pkg)}>
                  <img
                    src={pkg.image[0]}
                    alt="Package"
                    className="md:w-[300px] w-full rounded-md cursor-pointer"
                  />
                </div>
        ...
        <div className="md:w-1/3">
          <h4 className="text-xl font-bold self-center mt-2">
            Popular Packages
          </h4>
