        ...
        return (
          <>
            ...
            <input
              type="text"
              name="flightNumber"
              placeholder="Enter flight number (e.g., EK007)"
              className="w-full p-2 mb-4 border rounded"
              onChange={handleInputChange}
            />
            <input
              type="text"
              name="origin"
              placeholder="Origin airport (e.g., DXB)"
              className="w-full p-2 mb-4 border rounded"
              onChange={handleInputChange}
            />
            <input
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        {serviceTypes.map((service) => (
          <div
            ...
            className={`cursor-pointer p-6 rounded-lg transition-all duration-300 ease-in-out transform hover:scale-105 ${
