...
const Influencers = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            setFormData({ name: '', instagram: '', twitter: '', tiktok: '', facebook: '' });
        } catch (error) {
    ...
    const handleUpdate = async (e) => {
        ...
        try {
            const response = await axios.put(`${BaseUrl}/api/influencers/${selectedInfluencerId}`, data, {
                headers: { 'Content-Type': 'multipart/form-data' },
            });
    ...
    return (
        <div className="w-full mx-auto p-8 bg-white rounded-xl shadow-lg min-h-screen">
            ...
            <div className="w-full">
                ...
                {isFormVisible && (
                    <form onSubmit={isEditMode ? handleUpdate : handleSubmit} className="bg-gray-100 p-6 rounded-lg shadow-md mb-8">
                        ...
                        {/* Form fields */}
                        {['name', 'instagram', 'twitter', 'tiktok', 'facebook'].map((field) => (
