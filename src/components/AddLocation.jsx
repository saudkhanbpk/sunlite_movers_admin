...
const AddLocation = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            toast.success(editMode ? 'Location updated successfully!' : 'Location added successfully!');
                ...
                <div className="container mx-auto">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
                        {locations.slice(0, visibleCount).map((location) => (
                            <div key={location._id} className="bg-white shadow-md rounded-lg p-4 relative">
                                <img src={location.image} alt={location.name} className="w-full h-48 object-cover rounded-md" />
                                <h2 className="text-lg font-medium mt-2 text-center">{location.name}</h2>
                                <div className="flex justify-center space-x-4 mt-4">
                                    <button onClick={() => handleEdit(location)} className="text-blue-500 hover:text-blue-700">
                            ...
                            <form onSubmit={handleSubmit} className="space-y-4">
                                ...
                                >
                                    {loading ? (
                                        ...
                                        editMode ? 'Update Location' : 'Create now'
                                    )}
                                </button>
                            </form>
                        </div>
